...
def take_money():
    ...
    console.print(
        f"""\nI give you ${machine_status['money']} and machine has [red]0[/]
         balance""", style="bold plum4"
    )
...
def fill_machine_ingredients():
    ...
    console.print(
        """The machine cannot take more than 2000 ml of water, 2000 ml of milk,
         1000 grams of coffee and 20 disposable cups\n""", style="yellow")
    machine_stats()
        ...
        for key in machine_status:
            if key != "money":
                ...
                if (key == "coffee" and machine_status[key] + value > 1000):
                    raise ValueError(
                        """The entered value exceeds 1000 grams for coffee.
                        Please enter a value equal to or below {}"""
                        .format((1000 - machine_status[key]))
                    )
                if key == "cups" and machine_status[key] + value > 20:
                    raise ValueError(
                        """
                        The value exceeds 20 disposable cups that machine
                        can take. please enter a value equal or below {}
                        """
...
def buy_coffee():
    """"
    The function displays coffee choices to the user and ask for a choice
    ...
    if user_choice == '1':
        ...
        console.print(
            "\nInvalid. Please enter numeric numbers (1 -3) or enter 'back",
            style="dark_red"
        )
        buy_coffee()
